...
### **🎥 See the Official Demo (Click Below!)**

Curious how Nano Banana 2 generates those geographically accurate, real-time window views? **Watch the official "Window Seat" demo directly on the Google AI Blog!**

<p class="text-center mt-6 mb-8">
    <a href="https://blog.google/innovation-and-ai/technology/developers-tools/build-with-nano-banana-2/" target="_blank" class="bg-primary-500 hover:bg-primary-600 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-primary-500/30 transform hover:-translate-y-0.5 transition-all active:scale-95 whitespace-nowrap inline-flex items-center space-x-3">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 16 16"><path d="M8 1a7 7 0 100 14A7 7 0 008 1zm3.846 6.577L6.8 4.793a.5.5 0 00-.8.402v6.009a.5.5 0 00.8.402l5.046-3.784a.5.5 0 000-.804z"/></svg>
        <span>Watch "Window Seat" Demo on Google Blog</span>
    </a>
</p>
